...
//NAS VERSÕES ANTERIORES O PARÂMETRO-BASE ERA O CLICO (E EM FRAMES).
...
if(time >= start_t)
{
	currentTime = time - start_t;

	//Verifica se o tempo completou um ciclo
	n = currentTime/ciclo
...
((thisComp.duration - thisComp.frameDuration)*2)/(effect("telas")("Slider") + 1)
